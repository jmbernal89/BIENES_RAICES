    ...
    <table class="propiedades">
        ...
        <tbody>
            ...
            <?php foreach ($propiedades as $propiedad) : ?>
                <tr>
                    <td class="center"> <?php echo $propiedad->id; ?></td>
                    <td class="center"><?php echo $propiedad->titulo; ?></td>
    ...
    <table class="propiedades">
        ...
        <tbody>
            ...
            <?php foreach ($vendedores as $vendedor) : ?>
                <tr>
                    <td class="center"><?php echo $vendedor->id; ?></td>
                    <td class="center"><?php echo $vendedor->nombre . " " . $vendedor->apellido; ?></td>
